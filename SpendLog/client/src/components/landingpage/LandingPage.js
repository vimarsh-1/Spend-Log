    ...
    <div>
      ...
      <div className="centercontent">
        <div className="headline">
          <h1 className="firstline" data-aos="fade-down" data-aos-delay={500}>Track. Analyze. Save.</h1>
          <h5 className="secondline" data-aos="fade-down" data-aos-delay={800}>Smarter budgeting starts here.</h5>
          ...
          <Link to="/register"><button className="registerbtn" data-aos="zoom-in-up" data-aos-delay={1400}>Let's start with register 
            <img src={ArrowCircle} className="arrow-icon"  alt="" />
          </button>
          </Link>
        </div>
        <img src={Savings} className="landingpageimg" data-aos="zoom-in-up" data-aos-delay={1400} alt="" />
      </div>
    </div>
  );
};
